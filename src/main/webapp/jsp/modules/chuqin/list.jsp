                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            职务
                                            <select name="zhiwuTypesSelectSearch" id="zhiwuTypesSelectSearch" class="form-control form-control-sm"
                                                    aria-controls="tableId">
                                            </select>
                                        </label>
                                        ...
                                        <label>
                                            职称
                                            <select name="zhichengTypesSelectSearch" id="zhichengTypesSelectSearch" class="form-control form-control-sm"
                                                    aria-controls="tableId">
                                            </select>
                                        </label>
...
<script>
    ...
    function search() {
        ...
        if(zhiwuTypesSelectSearchInput != null){
            ...
            if( zhiwuTypesIndex  == 0){
                zhiwuTypesValue=null;
            }else{
                zhiwuTypesValue= document.getElementById("zhiwuTypesSelectSearch").options[zhiwuTypesIndex].value;
            }
            searchForm.zhiwuTypes = zhiwuTypesValue;
        }
                     
                            //职称
        var zhichengTypesSelectSearchInput = document.getElementById("zhichengTypesSelectSearch");
        if(zhichengTypesSelectSearchInput != null){
            var zhichengTypesIndex = zhichengTypesSelectSearchInput.selectedIndex;
            var zhichengTypesValue;
            if( zhichengTypesIndex  == 0){
                zhichengTypesValue=null;
            }else{
                zhichengTypesValue= document.getElementById("zhichengTypesSelectSearch").options[zhichengTypesIndex].value;
            }
            searchForm.zhichengTypes = zhichengTypesValue;
        }
        ...
        if(educationTypesSelectSearchInput != null){
            ...
            var educationTypesValue;
            if( educationTypesIndex  == 0){
                educationTypesValue=null;
            }else{
                educationTypesValue= document.getElementById("educationTypesSelectSearch").options[educationTypesIndex].value;
            }
            searchForm.educationTypes = educationTypesValue;
        }
                        <!-- 本表的查询条件 -->
        ...
        if(chuqinTypesSelectSearchInput != null){
            ...
            var chuqinTypesValue;
            if( chuqinTypesIndex  == 0){
                chuqinTypesValue=null;
            }else{
                chuqinTypesValue= document.getElementById("chuqinTypesSelectSearch").options[chuqinTypesIndex].value;
            }
            searchForm.chuqinTypes = chuqinTypesValue;
        }
    ...
    function setDataRow(item, number) {
        ...
        row.appendChild(zhiwuTypesCell);
                    ...
                    //职称
        var zhichengTypesCell = document.createElement('td');
        zhichengTypesCell.innerHTML = item.zhichengValue;
        row.appendChild(zhichengTypesCell);
