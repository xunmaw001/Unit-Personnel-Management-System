                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <div class="form-group col-md-6">
                                   ...
                                   <div class="form-group col-md-6">
                                       <label>职称</label>
                                       <select id="zhichengTypesSelect" name="zhichengTypes" class="form-control">
                                       </select>
                                   </div>
                                <div class="form-group col-md-6">
                                    <label>身份证号</label>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationZhichengtypesSelect(){
            var zhichengTypesSelect = document.getElementById('zhichengTypesSelect');
            if(zhichengTypesSelect != null && zhichengTypesOptions != null  && zhichengTypesOptions.length > 0 ){
                for (var i = 0; i < zhichengTypesOptions.length; i++) {
                    zhichengTypesSelect.add(new Option(zhichengTypesOptions[i].indexName,zhichengTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(zhichengTypesSelect != null && zhichengTypesOptions != null  && zhichengTypesOptions.length > 0 ) {
            for (var i = 0; i < zhichengTypesOptions.length; i++) {
                if (zhichengTypesOptions[i].codeIndex == ruleForm.zhichengTypes) {//下拉框value对比,如果一致就赋值汉字
                        zhichengTypesSelect.options[i].selected = true;
                }
            }
        }
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationZhichengtypesSelect();
    ...
    function readonly() {
        debugger
        if (window.sessionStorage.getItem('role') == '人事变动管理员' ) {
            ...
            $('#myPhotoupload').remove();
            $('#nation').attr('readonly', 'readonly');
            $('#politicsTypesSelect').attr('readonly', 'readonly');
            $('#politicsTypesSelect').attr('style', 'pointer-events: none;');
            $('#residence').attr('readonly', 'readonly');
            $('#birthplace').attr('readonly', 'readonly');
            $('#marriageTypesSelect').attr('readonly', 'readonly');
            $('#marriageTypesSelect').attr('style', 'pointer-events: none;');
            $('#educationTypesSelect').attr('readonly', 'readonly');
            $('#educationTypesSelect').attr('style', 'pointer-events: none;');
