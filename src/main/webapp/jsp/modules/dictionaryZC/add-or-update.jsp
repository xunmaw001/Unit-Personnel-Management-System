            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">职称管理</li>
                        <li class="breadcrumb-item active">编辑职称</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="dicCode" type="hidden" name="dicCode" class="form-control"
                                       value="zhicheng_types">
                                <input id="dicName"type="hidden" name="dicName" class="form-control"
                                       value="职称">
